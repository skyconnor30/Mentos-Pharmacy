...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0" style="font-weight:bold">
            <a href="index.php">หน้าหลัก</a> <span class="mx-2 mb-0">/</span>
            <strong class="text-black">ตะกร้าสินค้า</strong>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    ...
                    for ($i = 0; $i < $num; $i++) {
                      if (isset($data[$i])) {
                    ?>
                        <strong class="h5 text-black" style="margin-right:35pt"><?php echo $data[$i][0]['item_title'] ?></strong>
  ...
  ?>
    ...
    <img style="width:60rem; margin-left: 110pt;margin-right:auto" src="images/nocart.png" alt="">
  <?php
                  }
